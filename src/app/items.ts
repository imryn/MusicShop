...
export const ITEMS: Item[] = [
    {
        ...
        description: `is the sixth studio album by Australian hard rock band AC/DC, released
         ...
         and the sixth to be released in Australia. It was the last album featuring lead
         singer Bon Scott, who died early the following year on 19 February 1980.`,
        cost: 15,
    }  ,
    {
        ...
        description: `is a song by the British rock band Queen, featured on their 1978 album Jazz
         ...
         it was recorded in August 1978 at Super Bear Studios in Berre-les-Alpes (Alpes-Maritimes),
         France, and is the twelfth track on the album.`,
        cost: 22,
    } ,
    {
    ...
    } ,
    {
        ...
        description: `is the fourth studio album by English rock band Deep Purple,
         ...
         and peaked at No. 4 in the UK, remaining in the charts for months.`,
        cost: 15,
    } ,
    {
    ...
    } ,
    {
        ...
        description: `is the second studio album by British rock band Coldplay. It was
         ...
         Capitol Records in the United States. Recording started after the band became popular
         worldwide with the release of their debut album Parachutes.`,
        cost: 15,
    } ,
    {
        ...
        description: `The album was released to little mainstream attention in 1987. 
         ...
         after the band had toured and received airplay with the singles "Welcome to the Jungle",
         "Paradise City" and "Sweet Child of Mine". It topped the Billboard 200 and became
         the best-selling debut album of all time, as well as the eleventh best-selling
